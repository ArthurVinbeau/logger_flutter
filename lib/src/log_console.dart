...
/*
  ...
  edited code from https://github.com/xaynetwork/logger_flutter/blob/master/lib/src/log_console.dart
...
class RenderedEvent {
  ...
  RenderedEvent(this.id, this.level, this.spans, this.text);
}
...
class _LogConsoleState extends State<LogConsole> {
  ...
  RenderedEvent _renderEvent(OutputEvent event) {
    ...
    parser.parse(text, _logFontSize);
